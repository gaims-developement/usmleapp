...
import type { ReviewerConversation } from '@/mocks/reviewer/messages'

const ATTACHMENT = { name: 'attachment.pdf', size: '1.8 MB' }

export function ReviewerMessagesPage() {
  ...
  const selected = useMemo<ReviewerConversation | undefined>(() => {
  ...
  function insertTemplate(body: string) {
    const firstName = active.studentName.split(' ')[0]
  ...
  return (
    <div>
      <PageHeader
        title="Messages"
        subtitle="Communicate directly with students about their applications."
        actions={
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[11px] font-semibold text-brand-700">{c.applicationId}</p>
                  </div>
                </button>
              )
            })}
          ...
          {active ? (
            <>
              <header className="flex items-center justify-between gap-3 border-b border-ink-100 px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-display text-sm font-bold text-ink-900">{active.studentName}</p>
                    <p className="text-xs text-ink-500">
                      {active.country} · {active.applicationId}
                    </p>
                  </div>
                </div>
              ...
              <footer className="border-t border-ink-100 px-6 py-4">
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="max-h-80 overflow-y-auto p-2">
                      ...
                      {(templates.data ?? []).map(t => (
                        ...
                        >
                          ...
                          <span className="block truncate text-xs text-ink-500">{t.body}</span>
                        </button>
                      ))}
                    </div>
                  </Popover>
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder={`Message ${active.studentName.split(' ')[0]}…`}
            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-3 px-6 text-center">
              ...
              <p className="max-w-sm text-sm text-ink-500">
                Messages you exchange with applicants while reviewing their files will appear here.
              </p>
            </div>
          )}
        </section>
